...
<x-data-table :paginator="$clientes">
    <x-slot:header>
    ...
    <x-slot:filters>
        ...
        @error('excluir')
            <div class="mt-2 p-3 bg-red-50 border border-red-200 text-red-700 text-sm rounded-lg flex items-center gap-2">
    ...
    <table class="w-full table-fixed text-sm">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="text-left px-4 py-3 font-medium text-gray-500 uppercase tracking-wide text-xs w-[130px]">Telefone</th>
                        <th class="text-left px-4 py-3 font-medium text-gray-500 uppercase tracking-wide text-xs w-[140px] hidden md:table-cell">CPF/CNPJ</th>
                        <th class="text-left px-4 py-3 font-medium text-gray-500 uppercase tracking-wide text-xs w-[110px]">Score</th>
                        <th class="px-4 py-3 w-[72px]"></th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100">
                    @forelse($clientes as $cliente)
                        <tr class="hover:bg-gray-50 transition-colors cursor-pointer"
                            ...
                            <td class="px-4 py-3.5 font-medium text-gray-900 text-indigo-600 truncate">
                                {{ $cliente->nome }}
                            </td>
